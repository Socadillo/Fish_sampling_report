...
\pagestyle{fancy}                           %% Sets up the headers and footers
    ...
    \lhead{                                         %% Format the left header
      ...
      {\bfseries "Title of report"}}         %% Bold font
...
%%----------------TABLE OF CONTENTS
    ...
    \setcounter{tocdepth}{3}                                        %% Inlcude sub-subsections in TOC
...
%  \input{sections/methods}                                        %% Adds methods to report
  	\input{sections/ois}                                        %% Adds results to report
%    \input{sections/results}                                        %% Adds section about Ois river
